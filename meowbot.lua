...
title:SetText(i18n("MeowBot - Sinmeowgra"))

local title2 = frame:CreateFontString(nil, "OVERLAY", "GameFontNormal")
title2:SetPoint("TOP", frame, "TOP", 0, -17)
title2:SetText(i18n("Bot Order"))
...
distanceLabel:SetText(i18n("Set-Follow Distance:"))
...
local misclabel = distance2Button:CreateFontString(nil, "ARTWORK", "GameFontNormal")
misclabel:SetPoint("BOTTOM", distance2Button, "BOTTOM", 0, -14)
misclabel:SetText(i18n("Another Order:"))

local recallnew = CreateFrame("Button", "recallnew", frame, "UIPanelButtonTemplate")
recallnew:SetSize(60, 20)
recallnew:SetPoint("BOTTOM", misclabel, "BOTTOM", -35, -22)
recallnew:SetText(i18n("Recall"))
recallnew:GetNormalTexture():SetVertexColor(0.10, 1.00, 0.15)

local getinfobotnew = CreateFrame("Button", "getinfobotnew", frame, "UIPanelButtonTemplate")
getinfobotnew:SetSize(60, 20)
getinfobotnew:SetPoint("BOTTOMRIGHT", misclabel, "BOTTOMRIGHT", 30, -22)
getinfobotnew:SetText(i18n("Stats"))
getinfobotnew:GetNormalTexture():SetVertexColor(0.10, 1.00, 0.15)
...
recallnew:SetScript("OnClick", function()
  SendChatMessage(".npcbot recall", "SAY")
end)

getinfobotnew:SetScript("OnClick", function()
...
local function initializeFramesAndBars()
    ...
    for i = 1, numRaidMembers do
        ...
        memberFrame:SetPoint("TOPLEFT", TeamFrame, "TOPLEFT", 10 + 175 * column,
            -10 - ((row * 230) + (position - 1) * 42)) -- Adjusted offset to better fit the new layout
        ...
        local classColor = RAID_CLASS_COLORS[charClass] or {
            r = 1,
            g = 1,
            b = 1
        } -- Use a default color if characterClass is not found in RAID_CLASS_COLOR - Workaround for the delay of bots spawning
...
-- Register events
TeamFrame:RegisterEvent("UNIT_DISPLAYPOWER")
TeamFrame:RegisterEvent("PLAYER_TARGET_CHANGED")
TeamFrame:RegisterEvent("UNIT_NAME_UPDATE")
TeamFrame:RegisterEvent("UNIT_HEALTH")
TeamFrame:RegisterEvent("UNIT_MAXHEALTH")
TeamFrame:RegisterEvent("UNIT_MANA")
...
TeamFrame:RegisterEvent("PLAYER_REGEN_ENABLED")
TeamFrame:RegisterEvent("UNIT_SPELLCAST_SENT")
TeamFrame:RegisterEvent("UNIT_SPELLCAST_START")
TeamFrame:RegisterEvent("UNIT_SPELLCAST_STOP")
TeamFrame:RegisterEvent("UNIT_SPELLCAST_CHANNEL_STOP")
TeamFrame:RegisterEvent("UNIT_SPELLCAST_CHANNEL_START")
TeamFrame:RegisterEvent("UNIT_SPELLCAST_DELAYED")
TeamFrame:RegisterEvent("UNIT_SPELLCAST_CHANNEL_UPDATE")
TeamFrame:RegisterEvent("UNIT_SPELLCAST_SUCCEEDED")
TeamFrame:RegisterEvent("COMBAT_LOG_EVENT_UNFILTERED")
TeamFrame:RegisterEvent("PLAYER_TALENT_UPDATE")
TeamFrame:RegisterEvent("PLAYER_EQUIPMENT_CHANGED")
TeamFrame:RegisterEvent("PLAYER_TARGET_CHANGED")
TeamFrame:RegisterEvent("UPDATE_MOUSEOVER_UNIT")
TeamFrame:RegisterEvent("PLAYER_LEVEL_UP")
TeamFrame:RegisterEvent("GLYPH_ADDED")
TeamFrame:RegisterEvent("GLYPH_REMOVED")
TeamFrame:RegisterEvent("GLYPH_UPDATED")
TeamFrame:RegisterEvent("UNIT_AURA")
TeamFrame:RegisterEvent("UNIT_AURASTATE")
TeamFrame:RegisterEvent("UNIT_AURA")
TeamFrame:RegisterEvent("PARTY_MEMBERS_CHANGED")
